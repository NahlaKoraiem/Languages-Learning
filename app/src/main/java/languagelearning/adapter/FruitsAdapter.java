...
public class FruitsAdapter extends RecyclerView.Adapter<FruitsAdapter.ColorViewHolder>{
    ArrayList<FruitsHelper> fruit;
    private Context mContext;
    private RecyclerViewAction recyclerViewAction;

    public FruitsAdapter(ArrayList<FruitsHelper> fruit, Context mContext, RecyclerViewAction recyclerViewAction) {
        this.fruit = fruit;
    ...
    public ColorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_allvegetables, parent, false);
    ...
    public void onBindViewHolder(@NonNull ColorViewHolder holder, int position) {
        final FruitsHelper fruitHelper = fruit.get(position);

        holder.title.setImageResource(fruitHelper.getImage());
