...
public class FAlphabetAdapter extends RecyclerView.Adapter<FAlphabetAdapter.ColorViewHolder>{
    ArrayList<AlphabetHelper> alphabet;
    private Context mContext;
    private RecyclerViewAction recyclerViewAction;

    public FAlphabetAdapter(ArrayList<AlphabetHelper> alphabet, Context mContext, RecyclerViewAction recyclerViewAction) {
