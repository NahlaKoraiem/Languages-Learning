...
public class SAlphabetActivity extends AppCompatActivity implements RecyclerViewAction {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SAlphabetActivity.super.onBackPressed();
            }
        });
    ...
    private void featuredAlphabet() {
        ...
        questionLocations.add(new AlphabetHelper("Ñ"));
        ...
        adapter = new SAlphabetAdapter(questionLocations, this, this);
