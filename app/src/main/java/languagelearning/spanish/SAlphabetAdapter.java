...
public class SAlphabetAdapter extends RecyclerView.Adapter<SAlphabetAdapter.ColorViewHolder>{
    ArrayList<AlphabetHelper> alphabet;
    private Context mContext;
    private RecyclerViewAction recyclerViewAction;

    public SAlphabetAdapter(ArrayList<AlphabetHelper> alphabet, Context mContext, RecyclerViewAction recyclerViewAction) {
