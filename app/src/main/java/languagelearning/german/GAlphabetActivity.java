...
public class GAlphabetActivity extends AppCompatActivity implements RecyclerViewAction {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GAlphabetActivity.super.onBackPressed();
            }
        });
    ...
    private void featuredAlphabet() {
        ...
        questionLocations.add(new AlphabetHelper("Ä"));
        questionLocations.add(new AlphabetHelper("Ü"));
        questionLocations.add(new AlphabetHelper("Ö"));
        questionLocations.add(new AlphabetHelper("ẞ"));

        adapter = new GAlphabetAdapter(questionLocations, this, this);
