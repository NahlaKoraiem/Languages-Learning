...
public class GAlphabetAdapter extends RecyclerView.Adapter<GAlphabetAdapter.ColorViewHolder>{
    ArrayList<AlphabetHelper> alphabet;
    private Context mContext;
    private RecyclerViewAction recyclerViewAction;

    public GAlphabetAdapter(ArrayList<AlphabetHelper> alphabet, Context mContext, RecyclerViewAction recyclerViewAction) {
    ...
    public void onBindViewHolder(@NonNull ColorViewHolder holder, int position) {
        ...
        if (holder.title.getText().toString().equals("Ñ")) {
            holder.title.setTextColor(Color.parseColor("#ec407a"));
        }
        ...
        if (holder.title.getText().toString().equals("Ä")) {
            holder.title.setTextColor(Color.parseColor("#9c27b0"));
        }
        if (holder.title.getText().toString().equals("Ü")) {
            holder.title.setTextColor(Color.parseColor("#ec407a"));
        }
        if (holder.title.getText().toString().equals("Ö")) {
            holder.title.setTextColor(Color.parseColor("#2196f3"));
        }
        if (holder.title.getText().toString().equals("ẞ")) {
            holder.title.setTextColor(Color.parseColor("#9c27b0"));
        }
